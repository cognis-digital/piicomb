#!/usr/bin/env sh
# Universal installer for piicomb. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/piicomb.git"
echo "Installing piicomb ..."
